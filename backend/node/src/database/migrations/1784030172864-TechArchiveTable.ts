...
export class TechArchiveTable1784030172864 implements MigrationInterface {
    name = 'TechArchiveTable1784030172864'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "folders" ("id" SERIAL NOT NULL, "profile_id" integer NOT NULL, "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_8578bd31b0e7f6d6c2480dbbca8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "folder_tag_platforms" ("id" SERIAL NOT NULL, "folder_id" integer NOT NULL, "tag" character varying NOT NULL, "platform_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_85933c95022482e52b0439f00c8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "articles" ("id" SERIAL NOT NULL, "platform_id" integer NOT NULL, "source_type" integer NOT NULL, "title" character varying NOT NULL, "article_url" character varying NOT NULL, "thumbnail_url" text, "is_private" boolean NOT NULL DEFAULT false, "published_at" TIMESTAMP NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0a6e2c450d83e0b6052c2793334" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "folders" ADD CONSTRAINT "FK_7a60b43bee6440db9fa467fbc80" FOREIGN KEY ("profile_id") REFERENCES "profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "folder_tag_platforms" ADD CONSTRAINT "FK_81231a194a0d49d4ac790fd689a" FOREIGN KEY ("folder_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "folder_tag_platforms" ADD CONSTRAINT "FK_ebac8005496f562f434cf4b8cfd" FOREIGN KEY ("platform_id") REFERENCES "platforms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "folder_tag_platforms" DROP CONSTRAINT "FK_ebac8005496f562f434cf4b8cfd"`);
        await queryRunner.query(`ALTER TABLE "folder_tag_platforms" DROP CONSTRAINT "FK_81231a194a0d49d4ac790fd689a"`);
        await queryRunner.query(`ALTER TABLE "folders" DROP CONSTRAINT "FK_7a60b43bee6440db9fa467fbc80"`);
        ...
        await queryRunner.query(`DROP TABLE "folder_tag_platforms"`);
