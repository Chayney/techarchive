...
export class TechArchiveTable1782915956418 implements MigrationInterface {
    name = 'TechArchiveTable1782915956418'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "folder_platforms" ("id" SERIAL NOT NULL, "folder_id" integer NOT NULL, "platform_id" integer NOT NULL, "tag" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5f62fe073206da453fd7ec6a3d4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "folder_platforms" ADD CONSTRAINT "FK_f4e8e260d36e7850242d867c4b6" FOREIGN KEY ("folder_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "folder_platforms" ADD CONSTRAINT "FK_54a5058df1c3f6a864a612803b5" FOREIGN KEY ("platform_id") REFERENCES "platforms"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "folder_platforms" DROP CONSTRAINT "FK_54a5058df1c3f6a864a612803b5"`);
        await queryRunner.query(`ALTER TABLE "folder_platforms" DROP CONSTRAINT "FK_f4e8e260d36e7850242d867c4b6"`);
        ...
        await queryRunner.query(`DROP TABLE "folder_platforms"`);
