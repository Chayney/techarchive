...
export class TechArchiveTable1782651985419 implements MigrationInterface {
    name = 'TechArchiveTable1782651985419'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "folder_feeds" ("id" SERIAL NOT NULL, "folder_id" integer NOT NULL, "feed_id" integer NOT NULL, "tag" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_680746ffa7dd93274391a978f74" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "folder_feeds" ADD CONSTRAINT "FK_09e6dc7127c546a91a049e43185" FOREIGN KEY ("folder_id") REFERENCES "folders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "folder_feeds" ADD CONSTRAINT "FK_94b5a72ab9db6993969b0d45555" FOREIGN KEY ("feed_id") REFERENCES "feeds"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "folder_feeds" DROP CONSTRAINT "FK_94b5a72ab9db6993969b0d45555"`);
        await queryRunner.query(`ALTER TABLE "folder_feeds" DROP CONSTRAINT "FK_09e6dc7127c546a91a049e43185"`);
        ...
        await queryRunner.query(`DROP TABLE "folder_feeds"`);
